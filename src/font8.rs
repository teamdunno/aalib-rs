...
pub static mut font8data: [std::ffi::c_uchar; 2048] = [
    ...
    0x6b as std::ffi::c_int as std::ffi::c_uchar,
    ...
    0x6d as std::ffi::c_int as std::ffi::c_uchar,
    0xcf as std::ffi::c_int as std::ffi::c_uchar,
    ...
    0xdb as std::ffi::c_int as std::ffi::c_uchar,
    0x7e as std::ffi::c_int as std::ffi::c_uchar,
    0xd7 as std::ffi::c_int as std::ffi::c_uchar,
    0xed as std::ffi::c_int as std::ffi::c_uchar,
    0x18 as std::ffi::c_int as std::ffi::c_uchar,
    0x18 as std::ffi::c_int as std::ffi::c_uchar,
    0x18 as std::ffi::c_int as std::ffi::c_uchar,
    0x18 as std::ffi::c_int as std::ffi::c_uchar,
...
pub static mut aa_font8: aa_font = unsafe {
    {
        let mut init = aa_font {
            data: font8data.as_ptr(),
            height: 8,
            name: b"Standard vga 8x8 font\0" as *const u8 as *const std::ffi::c_char,
            shortname: b"vga8\0" as *const u8 as *const std::ffi::c_char,
        };
        init
    }
};
