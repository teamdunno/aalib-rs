...
pub static mut fontX13Bdata: [std::ffi::c_uchar; 3328] = [
    ...
    0x60 as std::ffi::c_int as std::ffi::c_uchar,
    0xf0 as std::ffi::c_int as std::ffi::c_uchar,
    0xbe as std::ffi::c_int as std::ffi::c_uchar,
    ...
    0x7c as std::ffi::c_int as std::ffi::c_uchar,
    0xd6 as std::ffi::c_int as std::ffi::c_uchar,
    0xd0 as std::ffi::c_int as std::ffi::c_uchar,
    0xf0 as std::ffi::c_int as std::ffi::c_uchar,
    0x7c as std::ffi::c_int as std::ffi::c_uchar,
    ...
    0xca as std::ffi::c_int as std::ffi::c_uchar,
    ...
    0x10 as std::ffi::c_int as std::ffi::c_uchar,
    0x7c as std::ffi::c_int as std::ffi::c_uchar,
    0xd4 as std::ffi::c_int as std::ffi::c_uchar,
    0xd0 as std::ffi::c_int as std::ffi::c_uchar,
    0xd0 as std::ffi::c_int as std::ffi::c_uchar,
    0xd4 as std::ffi::c_int as std::ffi::c_uchar,
    0x7c as std::ffi::c_int as std::ffi::c_uchar,
    ...
    0x6c as std::ffi::c_int as std::ffi::c_uchar,
    0xd8 as std::ffi::c_int as std::ffi::c_uchar,
    0xb0 as std::ffi::c_int as std::ffi::c_uchar,
    0xd8 as std::ffi::c_int as std::ffi::c_uchar,
    0x6c as std::ffi::c_int as std::ffi::c_uchar,
    0x36 as std::ffi::c_int as std::ffi::c_uchar,
    0 as std::ffi::c_int as std::ffi::c_uchar,
...
pub static mut aa_fontX13B: aa_font = unsafe {
    {
        let mut init = aa_font {
            data: fontX13Bdata.as_ptr(),
            height: 13 as std::ffi::c_int,
            name: b"X 8x13bold font\0" as *const u8 as *const std::ffi::c_char,
            shortname: b"X8x13bold\0" as *const u8 as *const std::ffi::c_char,
        };
        init
    }
};
